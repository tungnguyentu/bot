...
class BinanceClient:
    ...
    def set_leverage(self, symbol, leverage):
        ...
        try:
            ...
            if e.code == -4046:  # Leverage is too high
                logger.warning(
                    f"Leverage {leverage} is too high for {symbol}. Using maximum allowed leverage."
                )
                ...
                try:
                    ...
                    logger.info(
                        f"Set leverage for {symbol} to {max_leverage}x (maximum allowed)."
                    )
                    ...
                    logger.warning(
                        f"Continuing without setting leverage. Default leverage will be used."
                    )
    ...
    def create_market_order(self, symbol, side, amount):
        ...
        try:
            ...
            order = self.client.futures_create_order(
                symbol=symbol, side=side.upper(), type="MARKET", quantity=amount
            )
    ...
    def create_stop_loss_order(self, symbol, side, amount, stop_price, price=None):
        ...
        try:
            ...
            logger.info(
                f"Created stop loss {side} order for {amount} {symbol} at {stop_price}."
            )
    ...
    def create_take_profit_order(self, symbol, side, amount, stop_price, price=None):
        ...
        try:
            ...
            logger.info(
                f"Created take profit {side} order for {amount} {symbol} at {stop_price}."
            )
        ...
        try:
            ...
            for p in positions:
                if p["symbol"] == symbol:
                    ...
                    if (position_type == "long" and position_amt > 0) or (
                        position_type == "short" and position_amt < 0
                    ):
                        position = p
                        break
